...
rewind-client/main.py -p ../strategies/bot_17.mika 0 0 -p ../strategies/bot_12.mika 12 10 -f file -a 50 --proc 2
# rewind-client/main.py -p ../strategies/bot_17.mika 0 0 --replay ../games/18_12_2020_1608274856873.gamelog
